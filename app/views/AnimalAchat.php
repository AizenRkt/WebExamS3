                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Déclarer un animal que vous allez acheter</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                <form action="<?= Flight::base() ?>/t-AnimalAchat" method="get" class="form form-horizontal" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="nom" class="form-control" name="nom" placeholder="nom de l'animal" required>
                                            </div>
                                            ...
                                            <div class="col-md-8 form-group">
                                                <select name="idTypeAnimal" class="form-select" id="idType" required>
                                                    ...
                                                    <?php foreach ($types as $x) { ?>
                                                        <option value="<?= $x['idTypeAnimal'] ?>"><?= $x['espece'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
