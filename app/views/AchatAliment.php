...
<head>
    ...
    <title>Achat des aliments</title>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Stocker suffisament des aliments</h4>
                            </div>
                                    ...
                                    <form action="<?= Flight::base() ?>/stock-aliment" method="post" class="form form-horizontal">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="number" step="0.01" id="quantite" class="form-control" name="quantite" placeholder="Nombre de ce type d'aliment" required>
                                                </div>
