...
<head>
    ...
    <title>Login - identification en tant que admin</title>    
  ...
  <link rel="stylesheet" href="<?= Flight::base() ?>/public/assets/assets/compiled/css/auth.css">
</head>
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="index.html"><img src="<?= Flight::base() ?>/public/assets/assets/compiled/svg/logo.svg" alt="Logo"></a>
            </div>
            ...
            <form action="" method="post">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="password" name="pwd" class="form-control form-control-xl" placeholder="mot de passe">
                    <div class="form-control-icon">
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class="text-gray-600">vous n'etes pas un admin? <a href="" class="font-bold">passer en mode user</a>.</p>
            </div>
        </div>
    </div>
